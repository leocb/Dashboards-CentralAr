...
function pegarFretes() {
  //passa por todos os fretes da array
...
function getResults(CEP, n) {
  ...
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      try {
        ...
        //Pega o Prazo
        prazo = resposta.deliveryTime.match(/\d+(?=\s*dias?)/igm)[0];
        //Pega o Deposito
        deposito = resposta.filial_saida;
        //Monta a linha de saida final
        outText += "\n" + (n + 1) + "\tCentralAr.com\t" + CEPText[n] + "\t" + valor + "\t" + prazo + "\tsomente um tipo\t" + deposito;
        checkTotal();
      } catch (e) {
        console.error(e);
        outText += "\n" + (n + 1) + "\tCentralAr.com\t" + CEPText[n] + "\t\t\tsomente um tipo";
  ...
  xhttp.open("GET", "https://api-services.centralar.com.br/mds/rest/product/freight/v1?zipcode=" + CEP + "&code=1935", true);
