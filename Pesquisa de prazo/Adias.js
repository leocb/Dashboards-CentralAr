...
function GetResults (CEP, n) {
	...
	xhttp.onreadystatechange = function () {
		if (this.readyState == 4 && this.status == 200) {
			try {
				...
				outText += "\n" + (n + 1) + "\tAdias\t" + CEPText[n] + "\t" + valor + "\t" + prazoMenor + "\trapido";
				...
				//Monta a linha de saida (normal)
				outText += "\n" + (n + 1) + "\tAdias\t" + CEPText[n] + "\t" + valor + "\t" + prazoMaior + "\tnormal";
				...
				console.log(e);
				//marca como vazio
				outText += "\n" + (n + 1) + "\tAdias\t" + CEPText[n] + "\t\t\trapido";
				outText += "\n" + (n + 1) + "\tAdias\t" + CEPText[n] + "\t\t\tnormal";
				//verifica se já recebeu resposta de todos os fretes
				checkTotal();
			}
		}
	...
	xhttp.open("POST", "https://www.adias.com.br/Produto/CalculaFreteProduto", true);
	xhttp.setRequestHeader("Content-Type", "application/json; charset=utf-8");
	xhttp.setRequestHeader("Accept", "application/json, text/javascript, */*; q=0.01");
	xhttp.setRequestHeader("X-Requested-With", "XMLHttpRequest");
	//MODIFICAR ESSA URL, USAR O F12 NO BROWSER PRA PEGAR O PAYLOAD CORRETO PARA O PRODUTO (MENOS "CEP" E "FRETEABERTO")
