...
function GetResults(CEP, n) {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      try {
        ...
        //Pega o Prazo
        prazos = this.responseText.match(/\d+(?=\s*dias)/ig);
        var prazoMenor = 99;
        var prazoMaior = 0;
        var indiceMenor;
        var indiceMaior;
        ...
        //=========================================================== Rapido
        //Pega o valor
        valor =this.responseText.match(/R\$.?\d+\,\d+(?=.*dias?)/ig)[indiceMenor];
        //Monta a linha de saida (normal)
        outText += "\n" + (n + 1) + "\tFrigelar\t" + CEPText[n] + "\t" + valor + "\t" + prazoMenor + "\trapido";
        //verifica se já recebeu resposta de todos os fretes

        //=========================================================== Normal
        //Pega o valor
        valor =this.responseText.match(/R\$.?\d+\,\d+(?=.*dias?)/ig)[indiceMaior];
        //Monta a linha de saida (normal)
        outText += "\n" + (n + 1) + "\tFrigelar\t" + CEPText[n] + "\t" + valor + "\t" + prazoMaior + "\tnormal";
        ...
        console.log(e);
        //marca como vazio
        outText += "\n" + (n + 1) + "\tFrigelar\t" + CEPText[n] + "\t\t\trapido";
        outText += "\n" + (n + 1) + "\tFrigelar\t" + CEPText[n] + "\t\t\tnormal";
        //verifica se já recebeu resposta de todos os fretes
      }
      checkTotal();
    }
  ...
  xhttp.open("GET", "https://www.frigelar.com.br/frete/calcula/657?shippinCep=" + CEP + "&quantity=1&_=1525376084566", true);
  xhttp.send();
}
