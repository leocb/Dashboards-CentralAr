...
function GetResults(CEP, n) {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      try {
        ...
        //---------Saida---------
        //Pega o valor
        valor = eval(texto.valor).toFixed(2).replace(".", ",");
        //Pega o Prazo
        prazo = eval(texto.prazo);
        //Monta a linha de saida final
        outText += "\n" + (n + 1) + "\tRicardo Eletro\t" + CEPText[n] + "\t" + valor + "\t" + prazo + "\tsomente um tipo";
        ...
        //marca como vazio
        outText += "\n" + (n + 1) + "\tRicardo Eletro\t" + CEPText[n] + "\t\t\tsomente um tipo";
        //verifica se já recebeu resposta de todos os fretes
        checkTotal();
      }
    }
  ...
  xhttp.open("POST", "http://www.ricardoeletro.com.br/Frete/CalcularIndividual/673309", true);
