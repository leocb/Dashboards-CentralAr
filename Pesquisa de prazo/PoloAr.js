...
function GetResults(CEP, n) {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      try {
        ...
        //Pega o Prazo
        prazo = this.responseText.match(/\d+(?=\s*dias?)/i)[0];
        //Monta a linha de saida final
        outText += "\n" + (n + 1) + "\tPoloAr\t" + CEPText[n] + "\t" + valor + "\t" + prazo + "\tsomente um tipo";
        //verifica se já recebeu resposta de todos os fretes
        checkTotal();
      } catch (e) {
        //Monta a linha de saida final
        outText += "\n" + (n + 1) + "\tPoloAr\t" + CEPText[n] + "\t\t\tsomente um tipo";
        //verifica se já recebeu resposta de todos os fretes
        checkTotal();
      }
  ...
  xhttp.open("GET", "https://www.poloar.com.br/frete/calcula/315?shippinCep=" + CEP + "&quantity=1", true);
  xhttp.send();
}
